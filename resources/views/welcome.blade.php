...
<link rel="stylesheet" href="./css/video1.css"> <!-- Link to your CSS file -->
<link rel="stylesheet" href="./css/container.css"> <!-- Link to your CSS file -->
...
<link rel="stylesheet" href="./css/video2.css">
  ...
  <section class="opportunities">
    ...
    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vehicula cursus dolor, in laoreet nunc cursus in.</p>
 </section>
...
<!-- Register Now Button Section -->
  <!-- Register Now Button Section -->
  <section class="register-section-2">
    ...
    <div class="content">
        <h2 href="#" style="color: yellow; font-size: 3rem; font-weight: bold;">Register Now</h2>
        <p>Join us as a volunteer or charity and make a difference today!</p>
        <div class="buttons">
            <a href="volunteer.html" class="btn">Volunteer</a>
            <a href="charity.html" class="btn">Charity</a>
        </div>
    </div>
</section>
    ...
    <script>
      $(document).ready(function(){
        $('.owl-carousel').owlCarousel({
          ...
          stagePadding: 0, // No padding on the stage
